      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ControlPlane helps teams move work forward. Collaborate, manage
      ...
      <section className="bg-blue-600 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of teams who are already using ControlPlane to
            organize their work.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-xl font-bold">ControlPlane</span>
            </div>
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>© 2026 ControlPlane. All rights reserved.</span>
